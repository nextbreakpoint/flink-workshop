...
public class Arguments {
    ...
    public static final String CONSUMER_CONFIG_PATH = "CONSUMER_CONFIG_PATH";
    public static final String PRODUCER_CONFIG_PATH = "PRODUCER_CONFIG_PATH";
    public static final String LOCAL_ENVIRONMENT = "LOCAL_ENVIRONMENT";
    public static final String ENABLE_WEBUI = "ENABLE_WEBUI";
