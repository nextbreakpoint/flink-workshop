...
public class FlinkUtil {
    ...
    public static SourceFunction<SensorData> createKafkaSource(ParameterTool parameters, String topicName, KeyedDeserializationSchema<SensorData> schema, String jobGroupId, String autoOffsetReset) {
        ...
        final FlinkKafkaConsumer011<SensorData> kafkaConsumer011 = new FlinkKafkaConsumer011<>(topicName, schema, consumerProperties);
